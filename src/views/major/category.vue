...
<script>
  import { fetchMajorCats, createMajorCat, updateMajorCat, fetchMajorCatDetail } from '@/api/major'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        fetchMajorCats(this.listQuery).then(response => {
      ...
      handleUpdate(row) {
        ...
        fetchMajorCatDetail({ id: row.id }).then(response => {

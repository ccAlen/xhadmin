...
<script>
  import { fetchCertCats, createCertCat, updateCertCat, fetchCertCatDetail } from '@/api/cert'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        fetchCertCats(this.listQuery).then(response => {
      ...
      handleUpdate(row) {
        ...
        fetchCertCatDetail({ id: row.id }).then(response => {
